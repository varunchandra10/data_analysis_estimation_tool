...
class AppConfig(BaseModel):
	...
	ai_cache_dir: Path = Field(default=BASE_DIR / 'backend' / 'ai_cache')
	reports_dir: Path = Field(default=BASE_DIR / 'backend' / 'reports')
	archive_dir: Path = Field(default=BASE_DIR / 'backend' / 'datasets' / 'archive')
	exports_dir: Path = Field(default=BASE_DIR / 'backend' / 'exports')
	db_path: Path = Field(default=BASE_DIR / 'backend' / 'daet.sqlite3')
...
ARCHIVES_DIR = settings.archive_dir
